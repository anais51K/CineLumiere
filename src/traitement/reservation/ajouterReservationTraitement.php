...
if ($_SERVER['REQUEST_METHOD'] !== 'POST') { header('Location: ../../../public/reservation/ajouter.php'); exit; }
...
if (($a+$s+$e) < 1) { header('Location: ../../../public/reservation/ajouter.php?err='.urlencode('Au moins 1 place requise.')); exit; }
...
if ($seance) {
    ...
    if (($a+$s+$e) > $restantes) { header('Location: ../../../public/reservation/ajouter.php?err='.urlencode("Capacité insuffisante. Reste : $restantes place(s).")); exit; }
}
