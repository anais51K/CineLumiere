...
if ($_SERVER['REQUEST_METHOD'] !== 'POST') { header('Location: ../../../public/salle/liste.php'); exit; }
$id   = (int)($_POST['id'] ?? 0);
$code = trim($_POST['code'] ?? '');
$cap  = (int)($_POST['capacite_max'] ?? 0);
if (!$id || !$code || $cap < 1) { header('Location: ../../../public/salle/modifier.php?id='.$id.'&err='.urlencode('Code et capacité obligatoires.')); exit; }
