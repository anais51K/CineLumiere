...
if ($_SERVER['REQUEST_METHOD'] !== 'POST') { header('Location: /Cine_Lumiere/public/salle/ajouter.php'); exit; }
$code = trim($_POST['code'] ?? '');
$cap  = (int)($_POST['capacite_max'] ?? 0);
if (!$code || $cap < 1) { header('Location: /Cine_Lumiere/public/salle/ajouter.php?err='.urlencode('Code et capacité obligatoires.')); exit; }
