...
if ($_SERVER['REQUEST_METHOD'] !== 'POST') { header('Location: /Cine_Lumiere/public/film/ajouter.php'); exit; }
$nom   = trim($_POST['nom'] ?? '');
$duree = (int)($_POST['duree'] ?? 0);
if (!$nom || $duree < 1) {
    header('Location: /Cine_Lumiere/public/film/ajouter.php?err=' . urlencode('Nom et durée obligatoires.')); exit;
}
